        ...
        <div className="relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
            ...
            <div className="relative flex flex-col items-center text-center">
              <div className="w-24 h-24 rounded-2xl bg-white border border-warm-200 shadow-sm flex items-center justify-center mb-6 relative z-10">
                <Database className="w-10 h-10 text-brand-700" />
              </div>
              <h4 className="font-bold text-stone-900 mb-2">1. Discover</h4>
              <p className="text-xs text-stone-500">Identify official sources and directories across the city.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center text-center">
              ...
              <p className="text-xs text-stone-500">Pull unstructured data using Bright Data collectors.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center text-center">
              ...
              <p className="text-xs text-stone-500">Standardize prices, hours, and addresses into clean schemas.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center text-center">
              ...
              <p className="text-xs text-stone-500">Compute spatial proximity to hospitals, transit, and police.</p>
            </div>

            {/* Step 5 */}
            <div className="relative flex flex-col items-center text-center">
              <div className="w-24 h-24 rounded-2xl bg-white border border-warm-200 shadow-sm flex items-center justify-center mb-6 relative z-10 bg-brand-50 border-brand-200">
                <Eye className="w-10 h-10 text-brand-700" />
              </div>
              <h4 className="font-bold text-stone-900 mb-2">5. Deliver</h4>
              <p className="text-xs text-stone-500">Serve ranked, transparent results to the frontend.</p>
            </div>
          </div>
        </div>
      </div>
